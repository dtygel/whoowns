...
function create_whoowns_owner_post_type() {
	$labels = array(
		'name'                => _x( 'Owners', 'Post Type General Name', 'whoowns' ),
		'singular_name'       => _x( 'Owner', 'Post Type Singular Name', 'whoowns' ),
	...
	$args = array(
		...
		'taxonomies'          => array(''),//array( 'owner-type' ),
		'hierarchical'        => false,
		'public'              => true,
		'show_ui'             => true,
		'show_in_menu'        => true,
		...
		'menu_position'       => 5,
		'menu_icon'           => 'http://www.proprietariosdobrasil.org.br/templates/beez_20/favicon.ico',
		'can_export'          => true,
		'has_archive'         => true,
...
add_action( 'init', 'create_whoowns_owner_post_type', 0 );
