...
function whoowns_settings_page() {
	...
	<table class="form-table">
        ...
        <td><select name="whoowns_standard_decimal_symbol">
        	<option value="."<?php if (get_option('whoowns_standard_decimal_symbol')=='.') echo " selected='selected'"; ?>">.</option>
        	<option value=","<?php if (get_option('whoowns_standard_decimal_symbol')==',') echo " selected='selected'"; ?>">,</option>
        	</select>
        </td>
        </tr>
        ...
        <td><select name="whoowns_standard_thousand_symbol">
        	<option value="."<?php if (get_option('whoowns_standard_thousand_symbol')=='.') echo " selected='selected'"; ?>">.</option>
        	<option value=","<?php if (get_option('whoowns_standard_thousand_symbol')==',') echo " selected='selected'"; ?>">,</option>
        	</select>
        </td>
        </tr>
